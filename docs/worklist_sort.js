...
// Operates on the `patients` array from docs/sentinel_demo_patients_50 (the gold set;
// the app serves it via data/patients.json, generated by data/from_wiki.py).
